...
public class MyWebViewClient extends WebViewClient {
	...
	public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
		...
		Log.i("bqt", "【onReceivedError】" + request.getUrl().getPath() + "  " + error.getErrorCode() + "  " + error.getDescription());
	...
	public void onReceivedHttpError(WebView view, WebResourceRequest request, WebResourceResponse errorResponse) {
		...
		Log.i("bqt", "【onReceivedHttpError】" + request.getUrl().getPath() + "  "
	...
	public WebResourceResponse shouldInterceptRequest(WebView view, WebResourceRequest request) {
		...
		Log.i("bqt", "【shouldInterceptRequest】" + request.getUrl().getPath() + "  " + request.getMethod());
	...
	public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
		Log.i("bqt", "【shouldOverrideUrlLoading】" + request.getUrl().getPath() + "  " + request.getMethod());
		view.loadUrl(request.getUrl().getPath());//不去调用系统浏览器， 而是在本WebView中跳转
		return true;
	}
