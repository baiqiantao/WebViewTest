...
public class WebSettingsModel implements Parcelable {
	...
	public static final class Builder {
		...
		private boolean showHorizontalPB = false;//是否显示水平加载进度条
		private boolean showCenterPB = false;//是否显示中部圆形加载进度条
		...
		private int setMixedContentMode = 1;//设置混合模式。5.0开始默认为MIXED_CONTENT_NEVER_ALLOW，即https中不能加载http
